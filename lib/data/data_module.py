...
class MidiDataModule(pl.LightningDataModule):
    ...
    def train_dataloader(self):
        self.train = MidiDataset(f'{self.data_dir}/train/', self.max_seq, self.random_seq)
    ...
    def val_dataloader(self):
        self.val = MidiDataset(f'{self.data_dir}/val/', self.max_seq, self.random_seq)
    ...
    def test_dataloader(self):
        self.test = MidiDataset(f'{self.data_dir}/test/', self.max_seq, self.random_seq)
