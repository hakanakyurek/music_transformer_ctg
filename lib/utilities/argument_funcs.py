...
def print_train_args(args):
    ...
    logging.info("input_dir:", args.input_dir)
    logging.info("output_dir:", args.output_dir)
    logging.info("weight_modulus:", args.weight_modulus)
    logging.info("print_modulus:", args.print_modulus)
    logging.info("")
    logging.info("n_workers:", args.n_workers)
    logging.info("force_cpu:", args.force_cpu)
    logging.info("tensorboard:", not args.no_tensorboard)
    logging.info("")
    logging.info("continue_weights:", args.continue_weights)
    logging.info("continue_epoch:", args.continue_epoch)
    logging.info("")
    logging.info("lr:", args.lr)
    logging.info("ce_smoothing:", args.ce_smoothing)
    logging.info("batch_size:", args.batch_size)
    logging.info("epochs:", args.epochs)
    logging.info("")
    logging.info("rpr:", args.rpr)
    logging.info("max_sequence:", args.max_sequence)
    logging.info("n_layers:", args.n_layers)
    logging.info("num_heads:", args.num_heads)
    logging.info("d_model:", args.d_model)
    logging.info("")
    logging.info("dim_feedforward:", args.dim_feedforward)
    logging.info("dropout:", args.dropout)
    logging.info(SEPERATOR)
    logging.info("")
...
def print_eval_args(args):
    ...
    logging.info(SEPERATOR)
    logging.info("dataset_dir:", args.dataset_dir)
    logging.info("model_weights:", args.model_weights)
    logging.info("n_workers:", args.n_workers)
    logging.info("force_cpu:", args.force_cpu)
    logging.info("")
    logging.info("batch_size:", args.batch_size)
...
def print_generate_args(args):
    ...
    logging.info(SEPERATOR)
    logging.info("midi_root:", args.midi_root)
    logging.info("output_dir:", args.output_dir)
    logging.info("primer_file:", args.primer_file)
    logging.info("force_cpu:", args.force_cpu)
    logging.info("")
    logging.info("target_seq_length:", args.target_seq_length)
    logging.info("num_prime:", args.num_prime)
    logging.info("model_weights:", args.model_weights)
